...
bossfight = loadImage("images/bossF.png")
Debris1 = loadImage("images/debris1.png")
Debris2 = loadImage("images/debris2.png")
Debris3 = loadImage("images/debris.png")
...
wall = createSprite ( player1.x - 500,player1.y,20,1000)
wall.visible = false
...
bossF = createSprite(player1.x,player1.x + 300)
bossF.addImage("bossF",bossfight)
...
function draw() {
  ...
  let animations = [Debris1,Debris2,Debris3]
...
//camera.y = 2000
 ...
 textSize(40)
  textFont(fontH)
  fill("black")
       text("FOR CUTSCENE SCROLL DOWN",100,800)
  ...
  if(frameCount % 50 === 0)
{
  ...
  if(frameCount % 50 === 0){
  debris = createSprite(player1.x + (random(-200,200)),0,40,50)
  debris.velocityY = 12
  debris.lifetime = 60
debris.scale = 0.3
  debris.addImage("debris",random(animations))
 
  debrisGroup.add(debris)
  debrisGroup.collide(ground)
  

  if(debrisGroup.isTouching(player1))
  {
    P1health -= 30
  }
...
text("GRAY " , player1.position.x - 200, player1.position.y - 200 )
...
text("CONGRATULATIONS  FOR  COMPLETING  THE  DEMO " , player1.position.x - 500 , player1.position.y )
...
text("NOW  PAY  60  dollars  to  get  complete  edition ... just  kiddin  we  aint Ea  (pun  intended) " ,player1.position.x - 500,player1.position.y + 200)
